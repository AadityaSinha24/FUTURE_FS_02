...
["Pendant Publishing", "pendant.org"],
...
["Wayne Tech", "waynetech.io"],
 ["PeakSoft", "peaksoft.com"],
  ["NextWave Tech", "nextwave.tech"],
  ["Vertex Cloud", "vertexcloud.io"],
  ["Summit Innovations", "summitinnovations.com"],
  ["Atlas Dynamics", "atlasdynamics.io"],
  ["BlueOcean Labs", "blueoceanlabs.com"],
   ["CloudNest", "cloudnest.io"],
  ["Skyline Software", "skylinesoftware.com"],
  ["Quantum Logic", "quantumlogic.ai"],
  ["Evergreen Analytics", "evergreenanalytics.com"],
  ["Nimbus Labs", "nimbuslabs.dev"],
  ["FusionWorks", "fusionworks.io"],
...
const NOTE_TEMPLATES = [
  (c) => `Discovery call with ${c} went well — strong interest in the analytics module. Loop in a solutions engineer before the next call.`,
...
const run = async () => {
  ...
  let user = await User.findOne({ email: "alex@gmail.com" });
