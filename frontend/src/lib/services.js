...
export const leadsApi = {
  ...
  update: (id, data) => api.put(`/lead/${id}`, data),
  // update: (id, data) => {
  //   leads = leads.map((l) =>
...
export const analyticsApi = {
  overview: () => api.get("/analytic/overview"),
